...
### Quiz
	1. What function of the Azure AI Translator service should you use to convert the Chinese word "你好" to the English word "Hello"? 
		...
		1. [x] translate
		1. [ ] transliterate
	2. What function of the Azure AI Translator service should you use to convert the Russian word "спасибо" in Cyrillic characters to "spasibo" in Latin characters? 
		1. [ ] detect
		1. [ ] translate
		1. [x] transliterate
